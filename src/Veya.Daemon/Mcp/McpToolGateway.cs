...
/// <summary>
/// <see cref="IMcpToolGateway"/> backed by a real Veya.McpServer child
...
/// returns an empty list and <see cref="Veya.Daemon.ModelRouter"/> falls back
    ...
    : IMcpToolGateway, IAsyncDisposable
{
    ...
    private async Task EnsureConnectedAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var serverPath = serverOptions.ServerPath ?? Path.Combine(AppContext.BaseDirectory, "Veya.McpServer");
            ...
            {
                logger.LogWarning(ex, "Veya.McpServer is unavailable at '{ServerPath}'; continuing without tools.", serverPath);
                _tools = [];
            }
        }
        finally
