...
public sealed class ClipboardTool(ISafeExecutor executor, IPermissionGate permissionGate)
{
    ...
    [Description("Writes text to the user's system clipboard. Requires the user to have granted Veya the clipboard permission; if not granted, this does nothing and reports that it was denied.")]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return "Clipboard access is not granted. The user must enable the clipboard permission before Veya can write to it.";
        }
